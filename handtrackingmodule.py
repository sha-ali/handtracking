...
class handDetectore():
    ...
    def fingersup(self, lmListt):
        fingers = []
            # thumb
        if lmListt[self.tipid[0]][1] > lmListt[self.tipid[0] - 1][1]:
            fingers.append(1)
        else:
            fingers.append(0)
        ...
        # fingers
        for id in  range(1, 5):
            if lmListt[self.tipid[id]][2] < lmListt[self.tipid[id] - 1][2]:
                fingers.append(1)
            else:
                fingers.append(0)
    ...
    def finddistance(self, p1, p2, img, draw=True, r=15, t=3):
        ...
        if draw:
            ...
            cv2.circle(img, (cx, cy), r, (8, 0, 255), cv2.FILLED)
...
def main():
    ...
    while True:
        ...
        cv2.putText(img, str(int(fps)), (40, 50), cv2.FONT_HERSHEY_SCRIPT_COMPLEX, 3, (255, 0, 0), 3)
